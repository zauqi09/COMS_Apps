                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                   ...
                   <input type="hidden" name="id_client" value="'.$id_client.'" />
                      ...
                      <div class="form-group">
                        <label class="control-label col-sm-2" for="stasiun">WITEL:</label>
                        <div class="col-sm-10">
                         <div class="input-group">
                            <div class="input-group-addon">
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <input type="hidden" name="id_st" value="<?php echo "$id_blok"; ?>">
                      <div class="form-group">
                        <label for="inputName" class="col-sm-2 control-label">Nama WITEL</label>
                        <div class="col-sm-10">
                          <div class="input-group">
                            <div class="input-group-addon">
                              <i class="fa fa-train"></i>
                      ...
                      <div class="form-group">
                        <label for="inputTelp" class="col-sm-2 control-label">Telp WITEL</label>
                        <div class="col-sm-10">
                          <div class="input-group">
                            <div class="input-group-addon">
